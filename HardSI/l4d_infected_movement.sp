...
public void OnPluginStart()
{
	...
	g_hCvarBots =		CreateConVar(	"l4d_infected_movement_bots",			"6",			"These Special Infected bots can use: 1=Smoker, 2=Spitter, 4=Tank, 7=All. Add numbers together.", CVAR_FLAGS );
