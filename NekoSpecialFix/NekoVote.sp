...
public void OnPluginStart()
{
	...
	NCvar[Neko_CanSwitch] = 			AutoExecConfig_CreateConVar("Neko_CanSwitch", "1", "[0=关|1=开]全局投票开关", _, true, 0.0, true, 1.0);
	NCvar[Neko_SwitchStatus] = 			AutoExecConfig_CreateConVar("Neko_SwitchStatus", "1", "[0=关|1=开]玩家是否能投票更改插件状态", _, true, 0.0, true, 1.0);
	NCvar[Neko_SwitchNumber] = 			AutoExecConfig_CreateConVar("Neko_SwitchNumber", "0", "[0=关|1=开]玩家是否能投票更改特感数量", _, true, 0.0, true, 1.0);
	NCvar[Neko_SwitchTime] = 			AutoExecConfig_CreateConVar("Neko_SwitchTime", "1", "[0=关|1=开]玩家是否能投票更改刷特时间", _, true, 0.0, true, 1.0);
	NCvar[Neko_SwitchRandom] = 			AutoExecConfig_CreateConVar("Neko_SwitchRandom", "0", "[0=关|1=开]玩家是否能投票开关随机特感", _, true, 0.0, true, 1.0);
	NCvar[Neko_SwitchGameMode] = 		AutoExecConfig_CreateConVar("Neko_SwitchGameMode", "1", "[0=关|1=开]玩家是否能投票更改插件特感模式", _, true, 0.0, true, 1.0);
	NCvar[Neko_SwitchSpawnMode] = 		AutoExecConfig_CreateConVar("Neko_SwitchSpawnMode", "1", "[0=关|1=开]玩家是否能投票更改插件刷特模式", _, true, 0.0, true, 1.0);
	NCvar[Neko_SwitchPlayerJoin] = 		AutoExecConfig_CreateConVar("Neko_SwitchPlayerJoin", "1", "[0=关|1=开]玩家是否能投票设置根据玩家加入数量变动特感数量功能", _, true, 0.0, true, 1.0);
	NCvar[Neko_SwitchTankAlive] = 		AutoExecConfig_CreateConVar("Neko_SwitchTankAlive", "1", "[0=关|1=开]玩家是否能开关坦克存活时依旧刷特功能", _, true, 0.0, true, 1.0);
	NCvar[Neko_NeedResetNoPlayer] =		AutoExecConfig_CreateConVar("Neko_NeedResetNoPlayer", "1", "[0=关|1=开]全部玩家离开游戏后自动重置特感数据", _, true, 0.0, true, 1.0);
...
public Menu NekoVoteMenu(int client)
{
	...
	Format(line, sizeof(line), "插件目前状态 [%s]", !NCvar[Neko_CanSwitch].BoolValue ? "关" : "开");
