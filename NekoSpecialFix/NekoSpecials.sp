...
public void OnPluginStart()
{
	...
	NCvar[CSpecial_LeftPoint_SpawnTime] = 			AutoExecConfig_CreateConVar("Special_LeftPoint_SpawnTime", "16.0", "离开安全区域后多久刷特[默认5.0秒]", _, true, 0.1, true, 120.0);
	NCvar[CSpecial_Spawn_Time] = 					AutoExecConfig_CreateConVar("Special_Spawn_Time", "35", "全局特感刷新时间间隔[3-180]", _, true, 3.0, true, 180.0);
	...
	NCvar[CSpecial_Default_Mode] = 					AutoExecConfig_CreateConVar("Special_Default_Mode", "7", "指定刷新模式(当随机特感关闭生效)[1=全猎人|2=全牛|3=全猴子|4=全口水|5=全胖子|6=全舌头|7=默认][默认模式为全部特感类型都会刷新，其他为单一类型刷新]", _, true, 1.0, true, 8.0);
	...
	NCvar[CSpecial_Boomer_Num] = 					AutoExecConfig_CreateConVar("Special_Boomer_Num", "1", "Boomer最大刷新数量[当指定默认刷新模式时生效]", _, true, 0.0, true, 32.0);
	NCvar[CSpecial_Smoker_Num] = 					AutoExecConfig_CreateConVar("Special_Smoker_Num", "1", "Smoker最大刷新数量[当指定默认刷新模式时生效]", _, true, 0.0, true, 32.0);
	NCvar[CSpecial_Charger_Num] = 					AutoExecConfig_CreateConVar("Special_Charger_Num", "1", "Charger最大刷新数量[当指定默认刷新模式时生效]", _, true, 0.0, true, 32.0);
	NCvar[CSpecial_Hunter_Num] = 					AutoExecConfig_CreateConVar("Special_Hunter_Num", "1", "Hunter最大刷新数量[当指定默认刷新模式时生效]", _, true, 0.0, true, 32.0);
	NCvar[CSpecial_Spitter_Num] = 					AutoExecConfig_CreateConVar("Special_Spitter_Num", "1", "Spitter最大刷新数量[当指定默认刷新模式时生效]", _, true, 0.0, true, 32.0);
	NCvar[CSpecial_Jockey_Num] = 					AutoExecConfig_CreateConVar("Special_Jockey_Num", "1", "Jockey最大刷新数量[当指定默认刷新模式时生效]", _, true, 0.0, true, 32.0);

	NCvar[CSpecial_Boomer_Spawn_Weight] = 			AutoExecConfig_CreateConVar("Special_Boomer_Spawn_Weight", "70", "Boomer刷新概率[范围1-100|当其他特感也设置了数量时生效]", _, true, 1.0, true, 100.0);
	...
	NCvar[CSpecial_Spitter_Spawn_Weight] = 			AutoExecConfig_CreateConVar("Special_Spitter_Spawn_Weight", "70", "Spitter刷新概率[范围1-100|当其他特感也设置了数量时生效]", _, true, 1.0, true, 100.0);
