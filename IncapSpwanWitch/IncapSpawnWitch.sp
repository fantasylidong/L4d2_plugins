...
public void  OnPluginStart()
{
	...
	g_hDisAllowMode = CreateConVar("server_disallow_mode", "versus,scavenge,mutation2,mutation12,mutation13,mutation15,mutation18,survival", "黑名单模式.", 0, false, 0.0, false, 0.0);
