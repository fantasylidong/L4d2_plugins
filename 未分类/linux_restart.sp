...
public void OnPluginStart()
{
	...
	g_ConVarUnloadExtNum = CreateConVar("liunx_auto_restart_unload_ext_num", 			"4", 	"If you have Accelerator extension, you need specify here order number of this extension in the list: sm exts list", CVAR_FLAGS);
