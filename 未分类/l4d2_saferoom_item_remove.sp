...
public void OnPluginStart()
{
	...
	g_hCvarSaferoom = CreateConVar("sm_safeitemkill_saferooms", "3", "Saferooms to empty. Flags: 1 = end saferoom, 2 = start saferoom (3 = kill items from both).", _, true, 0.0, true, 3.0);
	g_hCvarItems = CreateConVar("sm_safeitemkill_items", "13", "Types to rmove. Flags: 1 = health items, 2 = guns, 4 = melees, 8 = all other usable items", _, true, 0.0, true, 15.0);
