...
BK_OnModuleStart()
{
	...
	BK_hEnable = CreateConVarEx("blockinfectedbots","0","Blocks infected bots from joining the game, minus when a tank spawns (1 allows bots from tank spawns, 2 removes all infected bots)");
