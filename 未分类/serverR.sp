...
public void OnPluginStart()
{
	...
	// CreateConVar
	g_hMotdTitle = CreateConVar("sm_cfgmotd_title", "今天你又来坐牢了？", "显示在 motd 上面的服务器标题", FCVAR_NOTIFY);
	g_hMotdUrl = CreateConVar("sm_cfgmotd_url", "http://sb.trygek.com:8880/l4d_stats/index.php", "显示给 motd 的 URL", FCVAR_NOTIFY);
	g_hIpUrl = CreateConVar("sm_cfgip_url", "http://sb.trygek.com:8880/", "显示 IP 的 URL", FCVAR_NOTIFY);
...
// 对抗计分面板出现前，切换游戏模式为写实，coop based on coop，实际为战役，不会出现计分板
...
// 开局，切换游戏模式为写实，realism based on versus，实际为对抗
