...
void PrintStatus(int client = -1)
{
	...
	if (client == -1)
	{
		if (g_bTankBhop)
		{
			if (g_bWeapon)
			{
				CPrintToChatAll("{lightgreen}模式{green}[{orange}%s{green}] {lightgreen}武器{green}[{orange}Zone{green}] {lightgreen}Tank连跳{green}[{orange}开启{green}] {lightgreen}特感{green}[{orange}%s%d特%d秒{green}] ", "牛牛冲刺大赛", spawnmode, g_iInfectedLimit, g_iInfectedTime);
			}
			else
			{
				CPrintToChatAll("{lightgreen}模式{green}[{orange}%s{green}] {lightgreen}武器{green}[{orange}Anne{green}] {lightgreen}Tank连跳{green}[{orange}开启{green}] {lightgreen}特感{green}[{orange}%s%d特%d秒{green}] ", "牛牛冲刺大赛", spawnmode, g_iInfectedLimit, g_iInfectedTime);
			}
		}
		else
		{
			if (g_bWeapon)
			{
				CPrintToChatAll("{lightgreen}模式{green}[{orange}%s{green}] {lightgreen}武器{green}[{orange}Zone{green}] {lightgreen}Tank连跳{green}[{orange}关闭{green}] {lightgreen}特感{green}[{orange}%s%d特%d秒{green}] ", "牛牛冲刺大赛", spawnmode, g_iInfectedLimit, g_iInfectedTime);
			}
			else
			{
				CPrintToChatAll("{lightgreen}模式{green}[{orange}%s{green}] {lightgreen}武器{green}[{orange}Anne{green}] {lightgreen}Tank连跳{green}[{orange}关闭{green}] {lightgreen}特感{green}[{orange}%s%d特%d秒{green}] ", "牛牛冲刺大赛", spawnmode, g_iInfectedLimit, g_iInfectedTime);
			}
		}
	}
	else
	{
		if (g_bTankBhop)
		{
			if (g_bWeapon)
			{
				CPrintToChat(client, "{lightgreen}模式{green}[{orange}%s{green}] {lightgreen}武器{green}[{orange}Zone{green}] {lightgreen}Tank连跳{green}[{orange}开启{green}] {lightgreen}特感{green}[{orange}%s%d特%d秒{green}] ", "牛牛冲刺大赛", spawnmode, g_iInfectedLimit, g_iInfectedTime);
			}
			else
			{
				CPrintToChat(client, "{lightgreen}模式{green}[{orange}%s{green}] {lightgreen}武器{green}[{orange}Anne{green}] {lightgreen}Tank连跳{green}[{orange}开启{green}] {lightgreen}特感{green}[{orange}%s%d特%d秒{green}] ", "牛牛冲刺大赛", spawnmode, g_iInfectedLimit, g_iInfectedTime);
			}
		}
		else
		{
			if (g_bWeapon)
			{
				CPrintToChat(client, "{lightgreen}模式{green}[{orange}%s{green}] {lightgreen}武器{green}[{orange}Zone{green}] {lightgreen}Tank连跳{green}[{orange}关闭{green}] {lightgreen}特感{green}[{orange}%s%d特%d秒{green}] ", "牛牛冲刺大赛", spawnmode, g_iInfectedLimit, g_iInfectedTime);
			}
			else
			{
				CPrintToChat(client, "{lightgreen}模式{green}[{orange}%s{green}] {lightgreen}武器{green}[{orange}Anne{green}] {lightgreen}Tank连跳{green}[{orange}关闭{green}] {lightgreen}特感{green}[{orange}%s%d特%d秒{green}] ", "牛牛冲刺大赛", spawnmode, g_iInfectedLimit, g_iInfectedTime);
			}
		}
	}
}
...
void ReloadPlugins()
{
	...
	ServerCommand("sm plugins reload optional/charger.smx");
