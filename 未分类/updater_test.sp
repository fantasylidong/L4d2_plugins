...
public OnPluginStart()
{
	...
	hCvar = CreateConVar("sm_updater", "2", "Determines update functionality. (1 = Notify, 2 = Download, 3 = Include source code)", FCVAR_NOTIFY|FCVAR_DONTRECORD, true, 1.0, true, 3.0);
