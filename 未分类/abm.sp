...
public void OnPluginStart() {
	...
	SetupCvar(g_cvTankChunkHp, "abm_tankchunkhp", "0", "Health chunk per survivor on 5+ missions");
	SetupCvar(g_cvSpawnInterval, "abm_spawninterval", "0", "SI full team spawn in (5 x N)");
	...
	SetupCvar(g_cvJoinMenu, "abm_joinmenu", "0", "0: Off 1: Admins only 2: Everyone");
	SetupCvar(g_cvTeamLimit, "abm_teamlimit", "12", "Humans on team limit");
